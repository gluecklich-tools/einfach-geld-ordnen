...
for($i=0; $i -lt $lines.Count; $i++){
  ...
  # "REPORT: C:\Users\carst\Projekte\Einfach-Geld-Ordnen\GitHub_Clone_Dateien\einfach-geld-ordnen\_local\reports\p0_hard_gates_glue_regex_20260228_154250.md"pwsh -NoProfile ...
  # "OK";pwsh -NoProfile ...
  # ..."}git status...
