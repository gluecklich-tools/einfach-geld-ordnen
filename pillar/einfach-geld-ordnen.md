...
1) Ueberblick: [Haushaltsueberblick]({{ site.baseurl }}/pillar/haushaltsueberblick.html)
2) Zahlen: [Haushaltsbuch]({{ site.baseurl }}/seiten/haushaltsbuch.html)
3) Danach je nach Lage:
- Luft schaffen: [Fixkosten senken]({{ site.baseurl }}/pillar/fixkosten-senken.html)
- Stabilisieren: [Spielraum & Ruecklagen]({{ site.baseurl }}/pillar/spielraum-ruecklagen.html)
